    ...
    return( 
        <div className='profile-about'>
                    ...
                    {edit ? 
                        <form className='edit-form'>
                            ...
                            <div className='edit-form-buttons'>
                                ...
                                {loading ? <button className='form-button-save disabled' onClick={handleDummyOnClick}><img src={loadingGif} className='about-property-loading'/></button> : <button className='form-button-save' onClick={handleSubmitOnClick}>Save</button>}
                            </div>
                        </form> : 
                        props.user.bio ? <p className='contact-symbol bio'>{props.user.bio}</p> : <div className='loading-container'><img src={loadingGif} className='about-loading'/></div>}
                </div>
            }
            ...
            {selection == 'Contact Info' &&
                <div className='profile-about-right'>
                    <h4>Contact Info</h4>
                    <p className='contact-symbol'><span className="material-symbols-rounded about-button-icon">email</span>{props.user.email ? props.user.email : <img src={loadingGif} className='about-property-loading'/>}</p>
                ...
                <div className='profile-about-right'>
                    ...
                    {edit ? 
                        ...
                        <div className='contact-symbol'>
                            ...
                            {props.user.gender ? props.user.gender : <img src={loadingGif} className='about-property-loading'/>}
                    ...
                    {birthdayEdit ? 
                        ...
                        : <div>
                            <p className='contact-symbol'>
                                ...
                                {props.user.birthday ? ((props.user.birthday === "1000-01-01T00:00:00.000Z" && props.user.facebookId) ? "Not Set" : new Date(props.user.birthday).toDateString() ): <img src={loadingGif} className='about-property-loading'/>}
                    ...
                    <p className='contact-symbol'>
                        ...
                        {props.user.accountCreationDate ? new Date(props.user.accountCreationDate).toDateString() : <img src={loadingGif} className='about-property-loading'/>}
                    </p>
                    ...
                    <p className='contact-symbol'>
                        ...
                        {props.user.posts ? `${props.user.posts.length} Posts` : <img src={loadingGif} className='about-property-loading'/>}
                    </p>
