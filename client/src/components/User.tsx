...
export default function User(): JSX.Element{
    ...
    return (
        <div className="profile">
            ...
            { user._id == '' ? 
                <div className='profile-load'><img src={loadingGif} className='user-loading'/></div>
            : <div>
                ...
                <div className='user-buttons'>
                    ...
                    {!isUser && isFriend ? (loading ? <div className='profile-unfriend disabled' onClick={handleDummyOnClick}><img className='about-property-loading' src={loadingGif} /></div> : <div className='profile-unfriend' onClick={handleUnfriendOnClick}><span className="material-symbols-rounded button-icon">person_remove</span>Unfriend?</div>) : ''}
                    {!isUser && !isFriend && request == '' ? (loading ? <div className='profile-not-friend disabled' onClick={handleDummyOnClick}><img className='friend about-property-loading' src={loadingGif}/></div> : <div className='profile-not-friend' onClick={handleRequestFriendOnClick}><span className="material-symbols-rounded button-icon" >person_add</span>Add Friend</div>) : ''}
                    {!isUser && !isFriend && request == 'Incoming' ? (loading ? <div className='profile-not-friend disabled' onClick={handleDummyOnClick}><img className='about-property-loading' src={loadingGif}/></div> : <div className='profile-not-friend' onClick={handleAcceptRequestOnClick}><span className="material-symbols-rounded button-icon">check_circle</span>Accept Request?</div>) : ''}
